...
import genVid from "../assets/EducationGen.mp4";
...
const Education = () => {
  ...
  return (
    <>
      ...
      className="w-full h-auto px-8 flex items-left justify-center flex-col">
          <Header />
          <section className="expertise-container pb-14 px-8 w-full h-auto flex items-left justify-center flex-col">
              <h1 className="w-full pt-[.8em] text-left text-[calc(16px_+_12vw)] text-white font-['Cinzel'] font-bold lg:pt-[.25em]">Education</h1>
              <div className='flex items-center justify-center flex-col lg:flex-col lg:justify-between'>
                <img 
                className='w-[400px] h-[240px] md:w-[520px] md:h-[300px] lg:w-[100%] lg:h-[860px] pt-16'
                src={bwoLogo} 
                  alt='The Block World Order'
                />
                <div className='w-full py-4 pt-16 pb-16 flex items-center justify-center flex-col gap-4 lg:w-2/2 lg:px-8'>
                  <small className="text-[calc(10px_+_.25vw)] text-white font-['Source Sans Pro'] font-thin">BLOCK WORLD ORDER</small>
                  <h3 className="text-left text-[calc(16px_+_2vw)] text-white font-['Cinzel'] font-thin text-center">EMBRACING THE 80% MINDSET, IGNITING THE 20% SKILLSET</h3>
                  <p className="text-left text-[calc(16px_+_.5vw)] text-white font-['Source Sans Pro'] font-thin text-center">
