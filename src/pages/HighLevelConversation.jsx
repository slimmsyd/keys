...
import genVid from "../assets/Gen2.mp4";
    ...
    <>
      ...
      className="w-full h-auto px-8 flex items-left justify-center flex-col">
          ...
          <section className="expertise-container pb-14 px-8 w-full h-auto flex items-left justify-center flex-col">
              ...
              <div className='py-[4em] flex items-left justify-center flex-col lg:flex-row-reverse lg:justify-between'>
                {/* <img 
                ...
                <div className='w-full py-4 flex items-left justify-center flex-col gap-4 lg:w-1/2 lg:px-8'>
                  <small className="text-[calc(10px_+_.25vw)] text-white font-['Source Sans Pro'] font-thin">THE HIGHEST THOUGHTS</small>
                  <h3 className="text-left text-[calc(16px_+_2vw)] text-white font-['Cinzel'] font-thin">ENLIGHTENING THOUGHT PATTERNS WITH 19 KEYS.</h3>
                  <p className="text-left text-[calc(16px_+_.5vw)] text-white font-['Source Sans Pro'] font-thin">
