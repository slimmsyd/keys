...
const Expertisesecond = () => {
  ...
  const applyScrollEffect = (ref, type = "default") => {
    ...
    if (type === "cut") {
      galleryItems = galleryEl.querySelectorAll(
        ".gallery__item-cut .gallery__item-inner"
      );
    } else {
    ...
    if (type !== "cut") {
      initialWidth =
        parseFloat(getComputedStyle(galleryItems[0]).width) /
        galleryEl.offsetWidth;
      initialHeight =
        parseFloat(getComputedStyle(galleryItems[0]).height) /
  ...
  return (
    <>
      ...
      <section className={`${styles.project} ${styles.project_intro}`}>
        <span
          className={`${styles.project__label} ${styles.project__label_name}`}
        >
          19 Keys
        </span>
        ...
        <span
          className={`${styles.project__label} ${styles.project__label__misson}`}
        >
          CNN News Article
        </span>
      ...
      <div ref={galleryRef} class="gallery-wrap">
        <div class="gallery gallery--row" id="gallery-1">
          <div
            class="gallery__item gallery__item--xl gallery__item--center"
            style={{ backgroundImage: `url(${KeysImage})` }}
          ></div>

          <div class="caption">
            Earn Your Leisure is a financial literacy movement with a different
            look and sound that brought thousands of African Americans to a
            conference in Atlanta recently. Despite the growth of the Black
            middle class, African Americans still grapple with the worst effects
            of rising inflation because they lag behind their White counterparts
            in income, wealth, financial savings and homeownership, researchers
            say. <br />
            <a
              href="https://www.cnn.com/2022/08/23/us/black-investors-earn-your-leisure-economy-reaj"
              target="_blank"
            >
              Read More
            </a>
      ...
      <section class="project project--details project--left">
        <span class="project__label project__label--default">
          Black Enterprise Youtube Channel.
          <br />
          19Keys Talks Black Empowerment.
        </span>

        <p>
          Financial literacy advocate, entrepreneur, and thought leader 19Keys
          opens up about his personal journey, insatiable hunger for knowledge,
          closing the racial wealth gap, and using cryptocurrency to empower the
          Black community.
        </p>
      </section>
      ...
      <div ref={galleryRef3} class="gallery-wrap gallery-wrap--large">
        <div class="gallery gallery--grid gallery--breakout" id="gallery-2">
          ...
          <div class="gallery__item gallery__item-cut">
            <div
              class="gallery__item-inner"
              style={{ backgroundImage: `url(${Keys2})` }}
            ></div>
          </div>
          <div class="gallery__item gallery__item-cut">
            <div
              class="gallery__item-inner"
              style={{ backgroundImage: `url(${KeysEylImage})` }}
            ></div>
          </div>
          <div class="gallery__item gallery__item-cut">
            <div
          ...
          <div class="caption">
            <p>
              Financial literacy advocate, entrepreneur, and thought leader
              19Keys opens up about his personal journey, insatiable hunger for
              knowledge, closing the racial wealth gap, and using cryptocurrency
      ...
      <section class="project project--details project--left">
        <span class="project__label project__label--default">
          Vanguard Article.
          <br />
          19KEYS IS A FIRM BELIEVER IN THE UNLIMITED POTENTIAL OF THE HUMAN
          MIND.
        </span>

        <p>
          Technological evolution has furthered disruptive technology, which for
          entrepreneurs means that one has to work extra hard today to enable
          their business to thrive in this new era. Nowadays, it is much easier
          to supersede old habits or products. Just look at what 19Keys has
          achieved by leveraging the tools of the age of technology!
        </p>
      </section>
      ...
      <div ref={galleryRef2} class="gallery-wrap">
        <div class="gallery gallery--row" id="gallery-1">
          ...
          <div class="caption">
            Financial literacy advocate, entrepreneur, and thought leader 19Keys
            opens up about his personal journey, insatiable hunger for
            knowledge, closing the racial wealth gap, and using cryptocurrency
            to empower the Black community.
            <br />
            <a
